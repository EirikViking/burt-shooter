...
Automated report: `test-results/mayhem-scout-difficulty-delta-2026-06-20T10-33-20-057Z/report.json`
...
No gameplay tuning was changed in this pass.
...
- boss HP and whether boss values changed by run mode

The check fails if Scout's incoming pressure is not at least 18% lower than Mayhem in every sampled sector. Boss HP must remain identical between Mayhem and Scout.

## Sector Comparison

| Sector | Mayhem level | Scout level | Enemy ratio | HP ratio | Projectile/fire ratio | Speed ratio | Elite ratio | Special ratio | Incoming pressure ratio | Clear-time ratio |
| ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| 1 | 10 | 5 | 0.807 | 0.807 | 0.344 | 0.869 | 0.481 | 0.374 | 0.202 | 0.918 |
| 5 | 14 | 9 | 0.883 | 0.441 | 0.667 | 0.876 | 0.592 | 0.601 | 0.235 | 0.768 |
| 10 | 19 | 14 | 0.738 | 0.738 | 0.457 | 0.876 | 0.536 | 0.556 | 0.255 | 0.779 |
| 20 | 29 | 24 | 1.000 | 1.000 | 0.590 | 0.880 | 0.620 | 0.587 | 0.465 | 1.000 |
| 30 | 39 | 34 | 1.000 | 1.000 | 0.590 | 0.880 | 0.620 | 0.573 | 0.460 | 1.000 |
...
Boss HP is unchanged between Mayhem and Scout. That matches the current design: Scout lowers normal-wave pressure and profile multipliers, but does not silently create a separate boss tuning profile.
...
Keep `scout_lower_pressure_v1` for this build.

The automated metrics show a clear lower-pressure gap without changing Mayhem, bosses, scoring, leaderboards, achievements, saves, Steam bridge, or Steamworks metadata.

Manual feel testing should still focus on whether late Scout sectors feel too close in enemy density despite reduced projectile/fire and threat pressure. If late Scout ever feels too busy, tune Scout through the existing mode profile rather than changing Mayhem or global balance.
...
5. Compare Sector 20 and Sector 30 feel in Mayhem vs Scout; enemy density may be similar, but Scout should be calmer due to reduced fire, projectile speed, enemy speed, elite, and special threat pressure.
