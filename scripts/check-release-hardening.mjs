...
const steps = [
  ...
  npmStep('gameplay backdrop motion', 'check:gameplay-backdrop-motion'),
  npmStep('gameplay backdrop runtime', 'check:gameplay-backdrop-runtime'),
  ...
  npmStep('fresh-profile Steam isolation', 'check:fresh-profile-steam-isolation'),
