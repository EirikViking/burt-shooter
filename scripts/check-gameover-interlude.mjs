...
try {
  ...
  assert(interludeState.gameOverAnimation?.visualLanguage === 'final_transmission_imagegen_v3_signal_atlas', 'final-death celebration is not using the rotating final-transmission visual language', interludeState.gameOverAnimation);
