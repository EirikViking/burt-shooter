...
import {CREATURE_DESIGNS, GENERATION_JOBS} from './creature-audio-design.mjs';
const root='docs/creature-audio';fs.mkdirSync(`${root}/originals`,{recursive:true});
...
const limit=Number(process.env.CREATURE_AUDIO_CREDIT_CEILING);
