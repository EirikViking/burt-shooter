...
- Production deploy verification: `https://burt.tinyfoundry.app/version.json` and `https://7fc7e98f.burt-game.pages.dev/version.json` both reported `v2026-05-17_19-42-24` after the Cloudflare Pages production deploy `https://7fc7e98f.burt-game.pages.dev`.
- Live-domain smoke: `SMOKE_URL=https://burt.tinyfoundry.app npm run smoke` passed at `test-results/smoke-2026-05-17T17-46-50-312Z/` with zero routine console output, console warnings/errors, page errors, or bad responses.
