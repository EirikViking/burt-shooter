import { MenuAudioTip, claimLaunchTip } from '../ui/MenuAudioTip.js';
...
export class MenuScene {
  ...
  update(delta) {
    if (this.launchAudioTip && !this.launchAudioTip.destroyed && this.astraMenuShip?.ready) {
      this.launchAudioTip.update(this.game.getWidth(), this.game.getHeight(), this.launchHome?.surface !== 'home');
    }
