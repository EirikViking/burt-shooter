...
const SHIP_BLUEPRINTS = [
    ...
    ['Pixel Needle', 'vector', 'Needle-nosed interceptor for precise dodgers.', 'needle', 3, 6.85, 128, 1.65, 12.7, 1, 0, 10, { shootSfx: 'shoot_small' }],
    ...
    ['Glacier Scope', 'glacier', 'Cold precision platform with fast straight projectiles.', 'scope', 11, 5.95, 144, 1.85, 13.2, 1, 0, 11, { shootSfx: 'shoot_small' }],
    ...
    ['Quartz Needle', 'quartz', 'Tiny hitbox, strict reload, beautiful threading.', 'quartz', 47, 6.35, 166, 2.10, 13.4, 1, 0, 10, { shootSfx: 'shoot_small' }],
    ['Chrome Rail', 'chrome', 'High-speed rail rounds for pattern readers.', 'rail', 50, 6.1, 164, 2.42, 13.9, 1, 0, 11],
