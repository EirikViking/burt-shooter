...
import {waveFlightPlan,sampleWaveFlight,sampleBossFlight,ENTRY_ROUTES,BOSS_FLIGHTS} from '../src/config/ArcadeFlight.js';
...
try {
 ...
 for(const level of [1,2,3,4,20]){const p=waveFlightPlan({},level,1,1,1280,720);assert.equal(p.durationScale,level<4?1:.94);}
...
const report={ok:true,entries,bossSamples,zeroGameplayRng:rng===0,protectedSpecialEntries:true,earlyEntryTimingUnchanged:true};
