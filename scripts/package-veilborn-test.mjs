...
const baseline='E:/Codex/builds/nova-swarm/encounter-pacing/package/win-unpacked';
const root='E:/Codex/builds/nova-swarm/veilborn-test-30/package',dist='E:/Codex/builds/nova-swarm/veilborn-test-30/build-dist';
...
if(!process.env.VEILBORN_TEST_PACKAGE_VERIFY_ONLY){
...
fs.writeFileSync('E:/Codex/builds/nova-swarm/veilborn-test-30/package.json',JSON.stringify(receipt,null,2));console.log('PASS',JSON.stringify({...receipt,changed:changed.length}));
