...
const POWERUP_CODEX_ENTRIES = Object.freeze([
  ...
  },
  {
    ...
    name: 'POINT DEFENSE',
    duration: '10 second',
    effect: 'a cyan ring that auto-intercepts hostile shots',
  ...
  },
  {
    id: 'bomb',
    name: 'BOMB',
    duration: 'three banked charges',
    effect: 'three heavy bombs you fire deliberately',
...
function rareChaosVisitorEntry(variant) {
  return {
    ...
    rarity: '0.4% WAVE CONTACT',
    role: 'EXTINCTION-CLASS CONTACT',
    description: '',
