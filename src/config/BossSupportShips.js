...
const SUPPORT_ROLES = [
  { id: 'fuel_runner', healPercent: 0.052, speed: 1.5, radius: 16, health: 2, score: 120, glyph: 'cells', beamStyle: 'pulse', deliveryFx: 'refuel' },
  { id: 'armor_mender', healPercent: 0.062, speed: 1.38, radius: 18, health: 3, score: 145, glyph: 'cross', beamStyle: 'braid', deliveryFx: 'armor' },
  { id: 'shield_tug', healPercent: 0.048, speed: 1.62, radius: 15, health: 2, score: 135, glyph: 'brackets', beamStyle: 'shield', deliveryFx: 'shield' },
  { id: 'spark_barge', healPercent: 0.07, speed: 1.26, radius: 20, health: 3, score: 160, glyph: 'spark', beamStyle: 'surge', deliveryFx: 'spark' },
  { id: 'mercy_skiff', healPercent: 0.056, speed: 1.54, radius: 17, health: 2, score: 130, glyph: 'halo', beamStyle: 'ribbon', deliveryFx: 'mercy' },
  { id: 'reactor_nurse', healPercent: 0.066, speed: 1.32, radius: 19, health: 3, score: 170, glyph: 'core', beamStyle: 'reactor', deliveryFx: 'reactor' },
  { id: 'panic_patch', healPercent: 0.044, speed: 1.7, radius: 15, health: 2, score: 150, glyph: 'chevron', beamStyle: 'stitch', deliveryFx: 'patch' },
  { id: 'warranty_tow', healPercent: 0.06, speed: 1.44, radius: 18, health: 3, score: 155, glyph: 'tow', beamStyle: 'towline', deliveryFx: 'tow' }
];
