...
- Production deploy verification: `https://burt.tinyfoundry.app/version.json` and `https://c440d94c.burt-game.pages.dev/version.json` both reported `v2026-05-17_21-11-41` after the Cloudflare Pages production deploy `https://c440d94c.burt-game.pages.dev`.
- Live-domain smoke: `SMOKE_URL=https://burt.tinyfoundry.app npm run smoke` passed at `test-results/smoke-2026-05-17T19-16-07-189Z/` with zero routine console output, console warnings/errors, page errors, or bad responses.
...
- Steam screenshot upload shortlist: `release/steam-screenshots/steam-upload-candidates-2026-05-17/`, refreshed from the current `v2026-05-17_21-11-41` release-build capture.
...
- Asset provenance inventory: `docs/asset-provenance.md`, `release/provenance/asset_provenance_manifest.json`, and `release/provenance/asset_provenance_report.json`; `npm run check:provenance` currently covers 1603/1603 scanned public/release assets while intentionally leaving legal approval pending.
