...
assert(wavePlan[9].bossHealth <= 270, `Level 10 boss health is too slow for the readable-tempo target (${wavePlan[9].bossHealth}).`, errors);
assert(diff.waveDelayMs <= 1150, `Between-wave briefing is too long (${diff.waveDelayMs}ms).`, errors);
