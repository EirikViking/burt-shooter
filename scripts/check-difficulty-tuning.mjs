...
assertRange('levels 11 to 15 serious normal waves', summaryByLabel.get('levels 11 to 15').increasePct / 100, [0.82, 0.96]);
assertRange('levels 16 to 20 early-late bridge', summaryByLabel.get('levels 16 to 20').increasePct / 100, [1.1, 1.27]);
