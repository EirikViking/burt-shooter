...
export const BalanceConfig = {
    ...
    difficulty: {
        ...
        highSectorEscalation: {
            ...
            pressureBudgetMax: 1.45,
            baseBriefingMs: 740,
            minimumBriefingMs: 520,
            briefingCompressionPerStepMs: 18,
            baseCleanupMs: 680,
            minimumCleanupMs: 460,
            cleanupCompressionPerStepMs: 16,
            minimumAnnouncementMs: 260,
            authoredEncounterLimit: 5,
            maxHostileProjectiles: 48,
