// Feature Flags for Asset Upgrades
// Master switches for enhanced visuals and audio

export const ENABLE_ASSET_UPGRADES = true;
export const ENABLE_ASSET_UPGRADES_START = true;
export const ENABLE_ASSET_UPGRADES_PLAY = true;
