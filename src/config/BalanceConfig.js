...
export const BalanceConfig = {
    ...
    difficulty: {
        ...
        mayhemReinforcements: {
            enabled: true,
            chance: 0.08,
            bossFightChance: 0.08,
            bossFightMinAgeMs: 8000,
            bossFightCheckIntervalMs: 3600,
            bossFightCooldownMs: 14500,
            bossFightMaxEvents: 2,
            doubleWaveChance: 0.18,
            doubleWaveMinLevel: 8,
            doubleWaveRequiresPriorReinforcement: true,
            firstPityEligibleMisses: 8,
            firstPityMinLevel: 5,
            firstPityMaxLevel: 8,
