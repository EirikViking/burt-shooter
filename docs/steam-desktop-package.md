...
- `npm run desktop:smoke:current` passed and wrote `test-results/electron-smoke-2026-05-17T16-17-15-205Z/` for build `v2026-05-17_18-16-08`.
- `npm run package:steam:win:current` produced `release/desktop/win-unpacked/Nova Swarm.exe` at 226,671,104 bytes.
