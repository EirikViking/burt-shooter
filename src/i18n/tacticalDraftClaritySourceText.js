...
const TRANSLATIONS = Object.freeze({
  de: Object.freeze([
    ...
    'SCHADEN', 'DIREKTER DPS', 'FEUERVERZÖGERUNG', 'GESCHOSSGESCHWINDIGKEIT', 'SCHÜSSE', 'DURCHDRINGUNG', 'KETTENREICHWEITE',
  ...
  es: Object.freeze([
    ...
    'DAÑO', 'DPS DIRECTO', 'RETARDO DE DISPARO', 'VELOCIDAD DE PROYECTIL', 'DISPAROS', 'PERFORACIÓN', 'ALCANCE DE CADENA',
  ...
  ru: Object.freeze([
    ...
    'УРОН', 'ПРЯМОЙ УВС', 'ЗАДЕРЖКА ОГНЯ', 'СКОРОСТЬ СНАРЯДА', 'ВЫСТРЕЛЫ', 'ПРОБИТИЕ', 'ДАЛЬНОСТЬ ЦЕПИ',
  ...
  'pt-BR': Object.freeze([
    ...
    'DANO', 'DPS DIRETO', 'INTERVALO DE TIRO', 'VELOCIDADE DO PROJÉTIL', 'TIROS', 'PERFURAÇÃO', 'ALCANCE DA CADEIA',
