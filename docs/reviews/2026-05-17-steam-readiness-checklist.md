...
- Steam screenshot candidate capture: `release/steam-screenshots/draft-2026-05-17-post-score-cleanup-1280/`
...
- Latest Steam screenshot refresh: `npm run capture:steam-screenshots` captured 10 clean post-score-cleanup current-build screenshots at `release/steam-screenshots/draft-2026-05-17-post-score-cleanup-1280/`, and the 8-shot upload shortlist plus `steam_upload_candidate_sheet.png` were refreshed from that capture. The capture report has zero console events, page errors, or bad responses.
