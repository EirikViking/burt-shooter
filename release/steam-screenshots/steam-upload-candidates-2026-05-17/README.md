...
- Source `report.json` records build `v2026-05-19_00-57-09`, matching `public/version.json` at capture time.
- Boss and wave-transition captures include the quieter message-focus timing, later score-flow/reward cleanup, generated hijacker art, tractor-beam mechanic, current arcade typography pass, announcer voice reboot build, advanced boss phase variety, and faster level-10 progression build.
