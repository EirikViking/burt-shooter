...
export const TACTICAL_DRAFT_AUGMENTS = Object.freeze([
  ...
  defineAugment({ id: 'rail_surge', evolutionName: 'HYPER-RAIL', category: 'offense', previewMetric: 'damage', draftDescription: 'Damage +5% and bullet speed +14%', modifiers: { damageMult: 1.05, bulletSpeedMult: 1.14 } }),
  defineAugment({ id: 'double_shot', evolutionName: 'TWIN VERDICT', category: 'offense', previewMetric: 'shots', draftDescription: 'Extra shot; damage -6%', modifiers: { shotBonus: 1, damageMult: 0.94 } }),
  defineAugment({ id: 'pierce', category: 'offense', previewMetric: 'piercing', draftDescription: 'Piercing shots; damage -3%', modifiers: { pierce: true, damageMult: 0.97 }, maxStacks: 1 }),
  defineAugment({ id: 'target_paint', evolutionName: 'KILL WARRANT', category: 'offense', previewMetric: 'damage', draftDescription: 'Damage +7% and fire rate +4%', modifiers: { damageMult: 1.07, fireDelayMult: 0.96 } }),
  defineAugment({ id: 'plasma_lance', evolutionName: 'SUNSPEAR', category: 'offense', previewMetric: 'damage', draftDescription: 'Damage +14%, bullet speed +8%, fire rate -4%', modifiers: { damageMult: 1.14, fireDelayMult: 1.04, bulletSpeedMult: 1.08 } }),
  ...
  defineAugment({ id: 'blink_drive', evolutionName: 'NULLSTEP DRIVE', category: 'mobility', previewMetric: 'dodgeCooldown', draftDescription: 'Movement speed +4% and dodge cooldown -16%', modifiers: { speedMult: 1.04, dodgeDelayMult: 0.84 } }),
  defineAugment({ id: 'vector_boost', evolutionName: 'VECTOR CROWN', category: 'mobility', previewMetric: 'movement', draftDescription: 'Movement speed +8% and dodge duration +10%', modifiers: { speedMult: 1.08, dodgeDurationMult: 1.1 } }),
  ...
  defineAugment({ id: 'focus_lens', name: 'FOCUS LENS', category: 'mobility', color: 0xffef7e, sfx: 'tactical_focus_lens', draftDescription: 'Focused shots deal +18% damage and tighten spread 40%', detail: 'Holding Focus routes every loose photon through the expensive glass. Shots tighten to 60% of their normal spread while focused, without changing projectile count or fire rate. The beam gets meaner, the ship gets deliberate, and nearby insurance forms begin filling themselves out.', modifiers: { focusDamageMult: 1.18, focusSpreadMult: 0.6 }, maxStacks: 1 }),
