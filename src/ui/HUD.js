...
export class HUD {
  ...
  updateLivesVisuals() {
    ...
    this.livesBg.moveTo(47, 10).lineTo(47, height-10).stroke({color:0x73d7df,width:1,alpha:.3});
    ...
    if (GameAssets.isValidTexture(portrait)) {
      ...
      this.livesShip.scale.set(Math.min(40/portrait.width, (height-10)/portrait.height));
      this.livesShip.position.set(24, height/2);
    }
