...
try{
 ...
 assert.deepEqual(reports[1].results,reports[0].results,'classic and arsenal emitted attacks, warnings, hazards, health, summons, RNG and 120-frame trajectories must match');
