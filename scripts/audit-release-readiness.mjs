...
const requiredFiles = [
  ...
  'release/steam-screenshots/draft-2026-05-17-brighter-1280/report.json',
...
checks.push({
  ...
  ...checkJsonReport('release/steam-screenshots/draft-2026-05-17-brighter-1280/report.json', (json) => ({
