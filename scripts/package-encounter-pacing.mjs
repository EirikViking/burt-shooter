...
const baseline='E:/Codex/builds/nova-swarm/mystery-v2/package/win-unpacked';
const root='E:/Codex/builds/nova-swarm/encounter-pacing/package',dist='E:/Codex/builds/nova-swarm/encounter-pacing/build-dist';
...
if(!process.env.PACING_PACKAGE_VERIFY_ONLY){
...
fs.writeFileSync('E:/Codex/builds/nova-swarm/encounter-pacing/package.json',JSON.stringify(receipt,null,2));console.log('PASS',JSON.stringify({...receipt,changed:changed.length}));
